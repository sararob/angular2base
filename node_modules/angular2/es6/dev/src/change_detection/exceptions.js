...
export class ExpressionChangedAfterItHasBeenCheckedException extends BaseException {
    constructor(proto, change, context) {
...
export class ChangeDetectionError extends BaseException {
    constructor(proto, originalException, originalStack, context) {
        super(`${originalException} in [${proto.expressionAsString}]`, originalException, originalStack, context);
