...
var CodegenNameUtil = (function () {
    ...
    CodegenNameUtil.prototype.getAllDetectorNames = function () {
        var _this = this;
        return collection_1.ListWrapper.map(collection_1.ListWrapper.filter(this.directiveRecords, function (r) { return !r.isDefaultChangeDetection(); }), function (d) { return _this.getDetectorName(d.directiveIndex); });
    };
