...
var WebWorkerMessageBus = (function () {
    ...
    WebWorkerMessageBus = __decorate([
        di_1.Injectable(), 
        __metadata('design:paramtypes', [WebWorkerMessageBusSink, WebWorkerMessageBusSource])
    ], WebWorkerMessageBus);
...
var WebWorkerMessageBusSink = (function () {
    ...
    WebWorkerMessageBusSink.prototype.send = function (message) { _postMessage(message); };
